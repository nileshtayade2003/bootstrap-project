<!-- https://shapedivider.app/    for dividers -->
<!-- https://lottiefiles.com/     for gif's -->
...
<body>
  ...
  <!-- navbar -->
    <nav class="navbar navbar-expand-lg bg-color py-5 pt-lg-5">
        <div class="container">
          <a class="navbar-brand text-white" href="/index.html">Nilesh Tech</a>
          ...
          <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item">
                <a class="nav-link ext-capitalize" href="/index.html#about-us">About</a>
              </li>
              <li class="nav-item">
                <a class="nav-link ext-capitalize" href="/index.html#online-section">Service</a>
              </li>
              <li class="nav-item">
      ...
      <div class="mb-3">
        <div class="row">
          ...
          <div class="col-lg-6 col-12">
             ...
             <input type="text" required class="form-control" id="exampleFormUserSecondName" placeholder="Last Name">
          </div>
        </div>
      </div>
...
<!-- shape divider -->
<style>
    .custom-shape-divider-bottom-1710568528 {
    position: absolute;
    bottom: 0;
    left: 0;
    width: 100%;
...
.custom-shape-divider-bottom-1710568528 svg {
    position: relative;
    display: block;
...
.custom-shape-divider-bottom-1710568528 .shape-fill {
    fill: #FFFFFF;
}
</style>
<div class="custom-shape-divider-bottom-1710568528">
  ...
  <div class="container px-5">
    <div class="row g-0">
      <div class="col-lg-4">
        <div class="contact-div p-5 d-flex flex-column justify-content-center align-items-center">
          <div class="icon-div d-flex justify-content-center align-items-center rounded-circle mb-3">
            <img src="images/call.gif" alt="Gif img" class="img-fluid">
          </div>
      ...
      <div class="col-lg-4">
        <div class="contact-div p-5 d-flex flex-column justify-content-center align-items-center">
          <div class="icon-div d-flex justify-content-center align-items-center rounded-circle mb-3">
            <img src="images/mail.gif" alt="Gif img" class="img-fluid">
          </div>
          <p class="text-white">(+00) 1234 5678</p>
        </div>
      </div>
      <div class="col-lg-4">
        <div class="contact-div p-5 d-flex flex-column justify-content-center align-items-center">
          <div class="icon-div d-flex justify-content-center align-items-center rounded-circle mb-3">
            <img src="images/map.gif" alt="Gif img" class="img-fluid">
          </div>
          <p class="text-white">(+00) 1234 5678</p>
        </div>
      </div>
...
<div class="row">
    <div class="col-lg-8 col-12 ">
        Copyright ©2024 All rights reserved. | This template is made with by <span class="bg-theme"> NileshTech</span>
    </div>
    <div class="col-md-4 col-12  ">
        <div class="d-flex justify-content-center justify-content-lg-end gap-5 mt-lg-0 mt-3">
            <a href="https://www.instagram.com/nileshtayade154/" target="_blank">
